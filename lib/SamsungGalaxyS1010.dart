...
import './SamsungGalaxyS1013.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.linear,
                  duration: 0.2,
                  pageBuilder: () => SamsungGalaxyS1013(),
                ),
              ],
          ...
          Pinned.fromPins(
            Pin(start: 24.0, end: 9.0),
            Pin(size: 119.0, middle: 0.2075),
            child: SvgPicture.string(
              _svg_g17une,
              allowDrawingOutsideViewBox: true,
              fit: BoxFit.fill,
          ...
          Align(
            alignment: Alignment(-0.435, -0.208),
            child: SizedBox(
              width: 59.0,
              height: 23.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.399, 0.347),
            child: SizedBox(
              width: 64.0,
              height: 28.0,
              child: Text(
          ...
          Pinned.fromPins(
            Pin(start: 44.0, end: 52.0),
            Pin(size: 54.0, middle: 0.5),
            child: Text(
              'I want to give 10 free doctor\n consultation',
              style: TextStyle(
                fontFamily: 'Report School',
                fontSize: 22,
          ...
          Pinned.fromPins(
            Pin(size: 58.0, start: 15.0),
            Pin(size: 58.0, middle: 0.6838),
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assets/images/ha.jpg'),
                  fit: BoxFit.cover,
                ),
                borderRadius: BorderRadius.circular(264.0),
              ),
            ),
          ),
          Pinned.fromPins(
            Pin(size: 58.0, start: 19.0),
            Pin(size: 58.0, middle: 0.3903),
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assets/images/as.jpg'),
                  fit: BoxFit.cover,
                ),
                borderRadius: BorderRadius.circular(204.0),
              ),
            ),
          ),
          Pinned.fromPins(
            Pin(size: 87.0, start: 5.0),
            Pin(size: 73.0, middle: 0.5779),
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage(''),
...
const String _svg_m6usiq =
    '<svg viewBox="17.0 337.0 327.0 119.0" ><path transform="translate(17.0, 337.0)" d="M 4 0 L 323 0 C 325.2091369628906 0 327 1.790860891342163 327 4 L 327 115 C 327 117.2091369628906 325.2091369628906 119 323 119 L 4 119 C 1.790860891342163 119 0 117.2091369628906 0 115 L 0 4 C 0 1.790860891342163 1.790860891342163 0 4 0 Z" fill="#478fe5" fill-opacity="0.4" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="round" /></svg>';
const String _svg_csvzmq =
    '<svg viewBox="17.0 543.0 327.0 119.0" ><path transform="translate(17.0, 543.0)" d="M 4 0 L 323 0 C 325.2091369628906 0 327 1.790860891342163 327 4 L 327 115 C 327 117.2091369628906 325.2091369628906 119 323 119 L 4 119 C 1.790860891342163 119 0 117.2091369628906 0 115 L 0 4 C 0 1.790860891342163 1.790860891342163 0 4 0 Z" fill="#478fe5" fill-opacity="0.4" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="round" /></svg>';
const String _svg_g17une =
    '<svg viewBox="24.0 133.0 327.0 119.0" ><path transform="translate(24.0, 133.0)" d="M 4 0 L 323 0 C 325.2091369628906 0 327 1.790860891342163 327 4 L 327 115 C 327 117.2091369628906 325.2091369628906 119 323 119 L 4 119 C 1.790860891342163 119 0 117.2091369628906 0 115 L 0 4 C 0 1.790860891342163 1.790860891342163 0 4 0 Z" fill="#478fe5" fill-opacity="0.4" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="round" /></svg>';
