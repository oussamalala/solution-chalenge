...
class SamsungGalaxyS1011 extends StatelessWidget {
  SamsungGalaxyS1011({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 48.0, middle: 0.3301),
            child: Text(
              'Tell us a bit about yourself so \nthey can better understand you ',
              style: TextStyle(
                fontFamily: 'Report School',
                fontSize: 20,
          ...
          Pinned.fromPins(
            Pin(size: 162.0, start: 18.0),
            Pin(size: 27.0, middle: 0.4256),
            child: Text(
              'What do you do ?',
              style: TextStyle(
                fontFamily: 'Report School',
          ...
          Pinned.fromPins(
            Pin(start: 22.0, end: 38.0),
            Pin(size: 54.0, middle: 0.6147),
            child: Text(
              'Describe the service you\'re going\n to donate',
              style: TextStyle(
                fontFamily: 'Report School',
                fontSize: 22,
                color: const Color(0xff0a0000),
          ...
          Align(
            alignment: Alignment(0.004, 0.663),
            child: Container(
              width: 131.0,
              height: 37.0,
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 20.0, middle: 0.4973),
            child: Text(
              'Write one line description about yourself',
              style: TextStyle(
                fontFamily: 'Report School',
                fontSize: 17,
                color: const Color(0x8a0a0000),
              ),
              textAlign: TextAlign.center,
              softWrap: false,
            ),
          ...
          Align(
            alignment: Alignment(-0.057, -0.628),
            child: Container(
              width: 99.0,
              height: 99.0,
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assets/images/youn.jpg'),
                  fit: BoxFit.cover,
                ),
                borderRadius:
                    BorderRadius.all(Radius.elliptical(9999.0, 9999.0)),
