...
class SamsungGalaxyS109 extends StatelessWidget {
  SamsungGalaxyS109({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: SingleChildScrollView(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Padding(
                      padding: EdgeInsets.fromLTRB(0.0, 0.0, -190.0, 0.0),
                      child: SingleChildScrollView(
                        primary: false,
                        child: Wrap(
          ...
          Pinned.fromPins(
            Pin(size: 94.0, start: 15.0),
            Pin(size: 30.0, middle: 0.2331),
            child: Text(
              'About It ',
              style: TextStyle(
          ...
          Pinned.fromPins(
            Pin(size: 182.0, end: 11.0),
            Pin(size: 39.0, middle: 0.2085),
            child: Text(
              'جمعية الصحة للجميع',
              style: TextStyle(
                fontFamily: 'Dubai',
          ...
          Pinned.fromPins(
            ...
            Pin(size: 320.0, middle: 0.3381),
            child: Text(
              'مجموعة من الاطباء متخصصين عايشوا معاناة \nعينة من المرضى المحتاجين وعدم تمكنهم \nمن شراء الادوية او القيام بتحاليل وتشخيصات \nبالاشعة ..وكانت مساعدتهم محققة بشكل علاقاتي.\n ومنها نبعت فكرة انشاء جمعية خيرية إنسانية\nاعتمدت الجمعية في 10 اكتوبر 2000 \nتحت اسم "الصحة للجميع" جمعية محلية ولائية\n اجتماعية و ثقافية علمية تم امتثالها لقانون\n الجمعيات رقم 06/12 بتاريخ 10/10/2013\n',
              style: TextStyle(
                fontFamily: 'Dubai',
                fontSize: 19,
          ...
          Pinned.fromPins(
            Pin(start: 44.0, end: 24.0),
            Pin(size: 64.0, middle: 0.5132),
            child: Text(
              'العاشر من أكتوبر الفين ( 10 اكتوبر 2000)\n',
              style: TextStyle(
                fontFamily: 'Dubai',
                fontSize: 19,
                color: const Color(0xff393636),
          ...
          Pinned.fromPins(
            ...
            Pin(size: 180.0, middle: 0.6135),
            child: Text(
              'التكفل الصحي الشامل بالافراد والاسر المحتاجة\nنشر الوعي الوقائي والتربية الصحية في وسط \nالمجتمع عامة شباب ونساء خاصة\nتنظيم دورات تدريبية وايام دراسية\nالتنسيق مع المجتمع المدني من اجل الخدمة العامة\n',
              style: TextStyle(
                fontFamily: 'Dubai',
                fontSize: 18,
          ...
          Pinned.fromPins(
            ...
            Pin(size: 30.0, end: 220.0),
            child: Text(
              'معا لكفالة الحق في الصحة وبناء مجتمع سليم',
              style: TextStyle(
                fontFamily: 'Dubai',
                fontSize: 18,
          ...
          Pinned.fromPins(
            Pin(size: 282.0, end: 15.0),
            Pin(size: 32.0, middle: 0.6585),
            child: Text(
            ...
            child: Text.rich(
              TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text: ' التكفل الصحي والتكافل الاجتماعي\n للاسر المعوزة\n',
                    style: TextStyle(
                  ...
                  TextSpan(
                    text: ' نشر الوعي الوقائي والتربية الصحية\n',
                    style: TextStyle(
                      color: const Color(0xff616161),
                    ),
                  ),
                  ...
                  TextSpan(
                    text:
                        ' ارساء شبكة جمعوية لتحقيق مردود \nنوعي يعود بالنفع العام للعباد و البلاد\n',
                    style: TextStyle(
                      color: const Color(0xff616161),
                    ),
                  ),
                  ...
                  TextSpan(
                    text:
                        'خلق مساحات التكوين والتمرس\n للشباب وفتح افاق لتطلعاتهم\n',
                    style: TextStyle(
                      color: const Color(0xff616161),
                    ),
                  ),
          ...
          Pinned.fromPins(
            Pin(size: 118.0, middle: 0.6736),
            Pin(size: 118.0, end: 87.0),
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
          ...
          Pinned.fromPins(
            Pin(size: 45.0, middle: 0.3746),
            Pin(size: 45.0, end: 124.0),
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
          ...
          Align(
            alignment: Alignment(0.065, -0.619),
            child: SizedBox(
              width: 82.0,
              height: 27.0,
              child: Stack(
