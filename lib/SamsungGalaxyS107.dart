...
import './SamsungGalaxyS109.dart';
import 'package:adobe_xd/page_link.dart';
import './SamsungGalaxyS1021.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => SamsungGalaxyS1021(),
                ),
              ],
              child: Container(
                decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 16.4, middle: 0.7749),
            Pin(size: 16.3, start: 96.0),
            child: Stack(
              children: <Widget>[
                Align(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 120.0, middle: 0.4016),
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assets/images/ cherity.jpg'),
                  fit: BoxFit.cover,
                ),
                borderRadius:
          ...
          Pinned.fromPins(
            Pin(size: 182.0, end: 18.0),
            Pin(size: 39.0, middle: 0.4133),
            child: Text(
              'جمعية الصحة للجميع',
              style: TextStyle(
                fontFamily: 'Dubai',
          ...
          Pinned.fromPins(
            Pin(size: 200.0, end: 9.0),
            Pin(size: 39.0, middle: 0.6436),
            child: Text(
...
const String _svg_nywwln =
    '<svg viewBox="4.5 4.5 13.2 13.1" ><path  d="M 17.72468948364258 11.06011199951172 C 17.72468948364258 14.68316268920898 14.76424407958984 17.6202220916748 11.11234569549561 17.6202220916748 C 7.460446834564209 17.6202220916748 4.5 14.68316268920898 4.5 11.06011199951172 C 4.5 7.437061786651611 7.460447788238525 4.5 11.11234569549561 4.5 C 14.76424407958984 4.5 17.72468948364258 7.437062740325928 17.72468948364258 11.06011199951172 Z" fill="none" stroke="#000000" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_ulpjt6 =
    '<svg viewBox="16.5 16.4 4.5 4.5" ><path transform="translate(-8.5, -8.61)" d="M 29.42640495300293 29.42640495300293 L 24.97499847412109 24.97499847412109" fill="none" stroke="#000000" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" /></svg>';
